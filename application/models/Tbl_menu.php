...
class Tbl_menu extends CI_Model {
    ...
    var $column_order = array(null, 'menu','name','locate_url'); //set column field database for datatable orderable
    var $column_search = array('menu','name','locate_url'); //set column field database for datatable searchable 
