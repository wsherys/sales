...
class Tbl_KasMasuk extends CI_Model {

	var $table = 'kas_masuk';
	var $column_order = array(null, 'nama_bisnis','tgl_invoice','jangka_waktu',
	'nomor_transaksi', 'nomor_pengiriman', 'nama_bank', 'nomor_rekening',
	'harga_total', 'status'); //set column field database for datatable orderable
	var $column_search = array('nama_bisnis','tgl_invoice','jangka_waktu',
	'nomor_transaksi', 'nomor_pengiriman', 'nama_bank', 'nomor_rekening',
	...
	private function _get_datatables_query()
	{
		...
		if($this->input->post('nama_bisnis'))
		{
			$this->db->like('nama_bisnis', $this->input->post('nama_bisnis'));
		}
	...
	function edit_data($where){		
		return $this->db->get_where('bisnis',$where);
	}
